    ...
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-smartdoc-slate-bg">
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-3xl border border-smartdoc-slate-border shadow-card">
        ...
        <div className="text-center space-y-3">
          ...
          <div className="pt-2">
            <h2 className="text-2xl font-bold text-smartdoc-navy">Reset Password</h2>
        ...
        <div className="p-3.5 rounded-xl bg-smartdoc-blue-soft border border-smartdoc-blue-border text-xs text-smartdoc-blue-dark flex items-start gap-2.5">
          ...
          <div>
            <span className="font-bold">Phase 1 Preview:</span> Password recovery workflows will be enabled in Phase 3.
          </div>
        </div>
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          <div className="space-y-1">
            <label className="text-xs font-semibold text-smartdoc-navy">Registered Email</label>
        ...
        <div className="text-center pt-4 border-t border-slate-100">
          <Link
            to="/login"
            className="inline-flex items-center gap-1.5 text-xs text-smartdoc-slate-muted hover:text-smartdoc-blue font-semibold transition-colors"
          >
