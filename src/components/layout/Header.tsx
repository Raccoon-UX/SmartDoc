  ...
  return (
    <header
      className={cn(
        ...
        isScrolled ? 'border-b border-slate-200/90 shadow-xs py-2.5' : 'border-b border-slate-200/70 py-3 sm:py-3.5'
      )}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2.5 px-3 py-1.5 text-xs text-slate-500 bg-slate-100/80 hover:bg-slate-200/70 border border-slate-200/80 rounded-xl transition-colors shadow-2xs"
                  ...
                  <>
                    ...
                    <div className="absolute right-0 top-full mt-2 w-72 bg-white rounded-2xl border border-slate-200 shadow-card-hover z-30 p-3 animate-in fade-in-50 zoom-in-95 duration-100">
                      <div className="flex items-center justify-between pb-2 border-b border-slate-100">
                        ...
                        <span className="text-[10px] font-semibold px-1.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700">1 New</span>
                      </div>
          ...
          <div className="flex items-center gap-1 md:hidden">
            ...
            {user && (
              <NavLink
                to="/dashboard/profile"
                className="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-600 to-violet-600 text-white text-xs font-bold flex items-center justify-center shadow-xs"
              >
                {avatarInitial}
              </NavLink>
            )}
